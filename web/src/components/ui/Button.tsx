...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-secondary text-white hover:bg-secondary-light focus:ring-secondary',
      secondary: 'bg-primary text-secondary hover:bg-primary-dark focus:ring-primary',
      outline: 'border-2 border-secondary text-secondary hover:bg-secondary/10 focus:ring-secondary',
      ghost: 'text-[var(--text)] hover:bg-[var(--surface-secondary)] focus:ring-secondary',
